...
const articleDataTablePart = {
  title: "Demographics",
  link: "demographics",
  redirect: `<div role="note" class="hatnote navigation-not-searchable">Main article: <a href="/wiki/Demographics_of_Martinique" title="Demographics of Martinique">Demographics of Martinique</a></div>`,
  summery: `<h2><span class="mw-headline" id="Demographics">Demographics</span><span class="mw-editsection"><span class="mw-editsection-bracket">[</span><a href="/w/index.php?title=Martinique&amp;action=edit&amp;section=17" title="Edit section: Demographics">edit</a><span class="mw-editsection-bracket">]</span></span></h2>
  <h3><span class="mw-headline" id="Population">Population</span><span class="mw-editsection"><span class="mw-editsection-bracket">[</span><a href="/w/index.php?title=Martinique&amp;action=edit&amp;section=18" title="Edit section: Population">edit</a><span class="mw-editsection-bracket">]</span></span></h3>
  <p>Martinique had a population of 385,551 as of January 2013.<sup id="cite_ref-pop_2-5" class="reference"><a href="#cite_note-pop-2">&#91;2&#93;</a></sup> There are an estimated 260,000 people of Martinican origin living in mainland France, most of them in the <a href="/wiki/Paris" title="Paris">Paris</a> region. Emigration was highest in the 1970s, causing population growth to almost stop, but it is comparatively light today.<sup id="cite_ref-britannica1_7-26" class="reference"><a href="#cite_note-britannica1-7">&#91;7&#93;</a></sup>
  </p>
  ...
  <tr>
  <td colspan="20" style="text-align:center;"><small>Official figures from past censuses and <a href="/wiki/INSEE" class="mw-redirect" title="INSEE">INSEE</a> estimates</small>
  </td></tr></tbody></table>`,
};
    ...
    <div>
      <Container fluid>
        ...
        <Row>
          ...
          <Col
            className="shadow p-3 mb-5 bg-white rounded app-article-shadow"
            md="8"
            lg="8"
            sm="7"
            xs="12"
